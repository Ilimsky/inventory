...
class _CreateSkedScreenState extends State<CreateSkedScreen> {
  ...
  // int? _getUserDepartmentId() {
  //   // Временная реализация - нужно интегрировать с вашей системой привязки пользователей
  //   // Пока возвращаем null, что ограничит доступ USER
  //   return null;
  //
  //   // В будущем можно будет сделать так:
  //   // final bindingService = Provider.of<BindingService>(context, listen: false);
  //   // return bindingService.getUserDepartmentId(authService.username);
  // }
                  ...
                  child: Card(
                    child: Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        value: selectedPlace,
                        items: ['Клиентская', 'Операционная', 'Хранилище', 'Прихожая', 'Директорская', 'Кухня', 'Балкон', 'Снаружи', 'Склад']
                            .map((category) => DropdownMenuItem(
                          value: category,
                          child: Text(
                            category,
